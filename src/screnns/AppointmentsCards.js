...
import { Text , SafeAreaView, View ,TextInput, ScrollView, TouchableOpacity, Image, ImageBackground} from "react-native";
...
const AppointmentsCards = () => {
    ...
    return(
        ...
        <SafeAreaView style={{flex:1}}>
            <ImageBackground style={{width:wp(100) , height: hp(30)}} source={require('../assets/images/AppointmentsIntroPic.jpg')}>
                     <View style={{width:wp(100) , height: hp(30) , backgroundColor:AppColor.blackOpacity8}}>
                        <Text style={[AppointmentStyle.viewOneContainerInnerViewSecondText,{fontSize:wp(10),marginTop:hp(3)}]}>Appointment</Text>
                        <Text style={[AppointmentStyle.viewOneContainerInnerViewSecondText,{fontSize:wp(3.3),width:wp(90)}]}>Effective appointment management in healthcare is crucial for ensuring patient satisfaction and improved outcomes. prioritizing timely appointments to build trust and foster strong doctor-patient relationships.</Text>
                     </View>
                    </ImageBackground>
            <ScrollView>
                        ...
                        <TouchableOpacity onPress={() => {navigation.navigate('MyAppointment')}}>
                            <NeoButton  height={hp(19)} width={wp(90)}  borderRadius={20} backgroundColor={AppColor.blackOpacity4} >
                                <View style={AppointmentStyle.viewOneContainerInnerView}>               
                                    ...
                                    <View style={{flex:3 , width:wp(30), height:hp(20)  , alignItems:"center" ,justifyContent:"center"}}>
                                        <Lottie style={{height:hp(17)}} source={require('../assets/animations/slots.json')} loop autoPlay/>
                                    </View>
                                </View>
                                </NeoButton>
                        </TouchableOpacity>
                            ...
                            <NeoButton  height={hp(19)} width={wp(90)} borderRadius={20} backgroundColor={"#b0704d"}  darkShadowColor={AppColor.black} marginBottom={hp(5)} >
                                <View style={AppointmentStyle.viewFiveContainerInnerView}>               
                                    ...
                                    <View style={AppointmentStyle.viewFiveContainerInnerViewTwo}>
                                        <Lottie style={{height: hp(30)}} source={require('../assets/animations/addNewSchedule.json')} loop autoPlay/>
                                    </View>
                                </View>
                            </NeoButton>
                        </TouchableOpacity>
                            ...
                            <NeoButton  height={hp(19)} width={wp(90)}  borderRadius={20} backgroundColor={"#708eb3"}>
                                <View style={AppointmentStyle.viewThreeContainerInnerView}>               
                                    ...
                                    <View style={AppointmentStyle.viewThreeContainerInnerViewTwo}>
                                        <Lottie style={{height: hp(11)}} source={require('../assets/animations/completedAppointments.json')} loop autoPlay/>
                                    </View>
                                </View>
                            </NeoButton>
                        </TouchableOpacity>
                            ...
                            <NeoButton  height={hp(19)} width={wp(90)}  borderRadius={20} backgroundColor={"#a18eab"} >
                                <View style={AppointmentStyle.viewTwoContainerInnerView}>               
                                    ...
                                    <View style={AppointmentStyle.viewTwoContainerInnerViewTwo}>
                                        <Lottie style={{height: hp(17)}}  source={require('../assets/animations/UpcomingAppointments.json')} loop autoPlay/>
                                    </View>
                                </View>
                            </NeoButton>
                        </TouchableOpacity>
                            ...
                            <NeoButton  height={hp(19)} width={wp(90)} borderRadius={20} backgroundColor={"#fa998e"} >
                                <View style={AppointmentStyle.viewFourContainerInnerView}>               
                                    ...
                                    <View style={AppointmentStyle.viewFourContainerInnerViewTwo}>
                                        <Lottie style={{height: hp(30)}}  source={require('../assets/animations/cancelledAppointments.json')} loop autoPlay/>
                                    </View>
                                </View>
                            </NeoButton>
                        </TouchableOpacity>
