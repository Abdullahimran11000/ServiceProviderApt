...
const TryAnotherWay = () => {
  ...
  const submitHandler = () => {
    if (phoneNumber === '') {
      setPhoneNumberLabel('Enter your phone number!');
  ...
  return (
    <SafeAreaView style={TryAnotherWayStyle.mainView}>
      <View style={TryAnotherWayStyle.headerCont}>
        <BackButton onPress={() => navigation.goBack()} />
      </View>
      <View style={TryAnotherWayStyle.bodyCont}>
        <ScrollView
          contentContainerStyle={TryAnotherWayStyle.scrollView}>
          ...
          <View>
            <Text style={TryAnotherWayStyle.text}>Phone Number </Text>
            ...
            {phoneNumberValidator ? (
              <Text style={TryAnotherWayStyle.textOne}>
                {phoneNumberLabel}
              </Text>
            ) : null}
          </View>
          <TouchableOpacity  onPress={submitHandler}>
            <NeoButton
              ...
              borderRadius={wp('10')} marginVertical={wp('10')}>
