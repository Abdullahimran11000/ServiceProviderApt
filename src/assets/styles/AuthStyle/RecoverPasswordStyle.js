...
const RecoverPasswordStyle = StyleSheet.create({
  ...
  inputView: {alignItems: "center", marginBottom: wp('3')},
  labelView: {width: wp('90')},
  labelText: {color: AppColor.black, fontFamily: 'Poppins-Bold',fontSize: wp('3.9')},
  inputStyleView: {flex: 1, flexDirection: 'row' , marginTop:wp('3'), marginBottom: wp('3'), width:wp('90'), height: hp('6.5'), borderRadius:wp('3'), backgroundColor: AppColor.white, alignItems: 'center'},
