...
const NotificationStyle = StyleSheet.create({
    ...
    headContImageCont: {width: wp('15'), height: wp('15'), borderRadius: wp('15'), backgroundColor: AppColor.whiteOpacity4, position: 'absolute', left: wp('2'), alignItems: 'center', justifyContent: 'center'},
